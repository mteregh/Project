...
categories = [
  ...
  {
    name: "Social",
    description: "Meetups and gatherings"
  }
...
event_draft = Event.create!(
  title: "Secret Admin Meeting",
  description: "Planning next semester",
  status: "draft",
  start_date: 5.days.from_now,
  end_date: 5.days.from_now + 2.hours,
  max_attendees: 20,
  user: users[0],
...
event_cancelled = Event.create!(
  ...
  end_date: 1.day.from_now + 4.hours,
  max_attendees: 100,
  user: users[3],
  category: categories[2],
  venue: venues[0]
